...
export default function Phase1Candidates() {
  ...
  const { data: candidates = [], isLoading, refetch } = useCandidates(1, searchQuery);
  ...
  const handleExport = () => {
    if (filteredCandidates.length > 0) {
      ...
      exportToCSV(exportData, 'phase1-candidates.csv');
    }
  };
